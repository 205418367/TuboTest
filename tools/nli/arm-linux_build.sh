...
if [ "$ARM_ABI" = "AARCH64" ];then
    ...
    SYSTEM=riscv64
    CCTOOL=riscv64-unknown-linux-gnu-gcc
    CXXTOOL=riscv64-unknown-linux-gnu-g++
    ...
    CCTOOL=aarch64-openwrt-linux-gcc
    CXXTOOL=aarch64-openwrt-linux-g++
    export TOOLCHAIN=/media/lichen/4T-data/workspace/3third/RTD1619B/toolchain-aarch64_cortex-a55_gcc-8.2.0_glibc
